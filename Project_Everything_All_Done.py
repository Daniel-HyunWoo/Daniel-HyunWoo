...
class MainWindow(QtWidgets.QMainWindow):   # dependng on desinger ui file, QMainWindow or QDialog ...
    def __init__(self):
        super().__init__()   
        ...
        self.ax = self.fig.add_subplot() # default: (111) == 1행 1열의 첫번째에 subplot, subplot은 그래프를 한 도화지에 여러개 그리기 위함
    ...
    def yt_plot(self):
        ...
        time.sleep(2) # to avoid TIMEOUT ERROR during autosetting
